...
\begin{itemize}
  ...
  \item ...
\end{itemize}
\note[item]{These are properties we can find on a datasheet.}
\note[item]{Academia: push to the limits}
\note[item]{Industry: satisfy management/customer spec.}

\column{.5\textwidth}
\textbf{Productivity/Efficiency}
\begin{itemize}
  \item fewer errors
  \item fewer iterations
  \item less manual work
  \item reduce execution cost
  \begin{itemize}
    \item setup time
    \item runtime
    \item hardware
    \item licenses
  \end{itemize}
  \item more accurate (simulation) results
  \item ...
\end{itemize}
\note[item]{execution: actually doing the design}
\end{columns}
\end{frame}

\begin{frame}
\frametitle{How to improve Quality and Productivity?}
\begin{columns}
\column{.5\textwidth}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item algorithm
    \note[item]{Develop new algorithms or apply existing algorithms for EDA purposes}
    \item utilities
    \note[item]{Apply new utilities for EDA purposes}
    \begin{itemize}
      \item hardware, e.g. GPU
      \note[item]{Decrease runtime of simulator or DRC with GPU}
      \item programming languages
      \note[item]{New HDL with existing programming language: SpinalHDL (Scala), Amaranth (Python)}
  ...
  \item integration with/of existing
  \begin{itemize}
    \item tools
    \item file formats
  \end{itemize}
...
\begin{itemize}
  ...
  \note[item]{related to integration cost}
...
\begin{itemize}
  \item accurate
  \item shared setup cost (simulation setup)
\end{itemize}
\end{center}
\column{.5\textwidth}
\begin{center}
