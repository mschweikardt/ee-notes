...
\end{equation}
\begin{equation}
y_{\mathrm{m}} = 1 + \mathrm{OS} = 1 + \exp\left\{-\frac{\pi}{\sqrt{4Q^2-1}}\right\}
\end{equation}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}              
  \end{tikzpicture}
  \caption{Overshoot $\mathrm{OS}$ vs. quality $Q$ (only underdamped case)}
  \label{fig:os}
\end{figure}
