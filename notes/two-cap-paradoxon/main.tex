...
\end{equation}
\begin{equation}
E_{\mathrm{C,2}}(t\leq0) = \SI{0}{\joule}
\end{equation}
...
\begin{equation}
\begin{split}
W_{\mathrm{R}} & = E_{\mathrm{C,1}}(t\leq0)         + E_{\mathrm{C,2}}(t\leq0) - E_{\mathrm{C,1}}(t\rightarrow \infty)                  - E_{\mathrm{C,2}}(t\rightarrow \infty)                      \\
               & = \frac{1}{2} C_1 V_{\mathrm{0}}^2 + \SI{0}{\joule}           - \frac{1}{2} \frac{C_1^3}{(C_1+C_2)^2} V_{\mathrm{0}}^2 - \frac{1}{2} \frac{C_1^2 C_2}{(C_1+C_2)^2} V_{\mathrm{0}}^2 \\
