...
\begin{equation}
\begin{split}
\left|\underline{F}(j\omega)\right|_{\mathrm{dB}} &= 20 \cdot\log\left(1+\left(\frac{\omega}{\omega_{\mathrm{z}}}\right)^2\right) - 20 \cdot\log\left(1+\left(\frac{\omega}{\omega_{\mathrm{p}}}\right)^2\right) \\
                                                  &= 20 \cdot\log\left(1+\left(\frac{\omega}{\omega_{\mathrm{z}}}\right)^2\right) - 20 \cdot\log\left(1+\left(\frac{1}{\delta} \frac{\omega}{\omega_{\mathrm{z}}}\right)^2\right) 
\end{split}
\end{equation}
...
\begin{tikzpicture}
  \begin{axis}[ ylabel=$\left|\underline{F}(j\omega)\right|$ in \si{\decibel}
     ...
     \addplot[ domain=0.1:1000
             , samples=31
             , smooth
             , thick] {20*log10(sqrt(1+x^2))-20*log10(sqrt(1+(x/0.316225)^2))};     
     \addplot[ domain=0.1:1000
             , samples=31
             , smooth
             , thick] {20*log10(sqrt(1+x^2))-20*log10(sqrt(1+(x/0.1)^2))};
     \addplot[ domain=0.1:1000
             , samples=31
             , smooth
             , thick] {20*log10(sqrt(1+x^2))-20*log10(sqrt(1+(x/0.0316225)^2))};
     ...
     \addplot[ domain=0.1:1000
      ...
      \node[anchor=south,font=\small,fill=white,inner sep=0.5pt] 
...
\begin{tikzpicture}
  \begin{axis}[ ylabel=$\arg\left(\underline{F}(j\omega)\right)$ in \si{\degree}
     ...
     \addplot[ domain=0.6:50
      ...
      \node[anchor=west,font=\small,fill=white,inner sep=0.5pt] (a)
        at (axis cs:10,-30) {$\delta=0.316$};
      \draw[thin,gray] (a.west) -- (axis cs:1.5,-22);

      \node[anchor=west,font=\small,fill=white,inner sep=0.5pt] (b)
        at (axis cs:3,-50) {$\delta=0.1$};
      \draw[thin,gray] (b.west) -- (axis cs:0.5,-52);

      \node[anchor=west,font=\small,fill=white,inner sep=0.5pt] (c)
      ...
      \node[anchor=north,font=\small,fill=white,inner sep=0.5pt,rotate=-66] 
...
\section{Pole and Zero-Pole Doublet}
